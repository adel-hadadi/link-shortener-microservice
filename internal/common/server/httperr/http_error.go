...
import (
	...
	"github.com/adel-hadadi/link-shotener/internal/common/errors"
...
func DuplicateEntry(slug string, err error, w http.ResponseWriter, r *http.Request) {
	httpRespondWithError(err, slug, w, r, "Duplicate entry", http.StatusConflict)
}
...
func RespondWithSlugError(err error, w http.ResponseWriter, r *http.Request) {
	...
	case errors.ErrorTypeConflict:
		DuplicateEntry(slugError.Slug(), slugError, w, r)
	default:
