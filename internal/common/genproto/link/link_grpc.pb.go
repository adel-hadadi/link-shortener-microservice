...
const (
	LinkService_Create_FullMethodName = "/link.LinkService/Create"
	LinkService_Get_FullMethodName    = "/link.LinkService/Get"
)
...
type LinkServiceClient interface {
	Create(ctx context.Context, in *CreateLinkRequest, opts ...grpc.CallOption) (*LinkResponse, error)
	Get(ctx context.Context, in *GetLinkRequest, opts ...grpc.CallOption) (*LinkResponse, error)
}
...
func (c *linkServiceClient) Create(ctx context.Context, in *CreateLinkRequest, opts ...grpc.CallOption) (*LinkResponse, error) {
...
func (c *linkServiceClient) Get(ctx context.Context, in *GetLinkRequest, opts ...grpc.CallOption) (*LinkResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(LinkResponse)
...
type LinkServiceServer interface {
	Create(context.Context, *CreateLinkRequest) (*LinkResponse, error)
	Get(context.Context, *GetLinkRequest) (*LinkResponse, error)
}
...
func (UnimplementedLinkServiceServer) Create(context.Context, *CreateLinkRequest) (*LinkResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method Create not implemented")
}
func (UnimplementedLinkServiceServer) Get(context.Context, *GetLinkRequest) (*LinkResponse, error) {
