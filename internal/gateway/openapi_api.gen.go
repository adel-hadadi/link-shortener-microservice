...
// (GET /{shortURL})
func (_ Unimplemented) RedirectToURL(w http.ResponseWriter, r *http.Request, shortURL string) {
	w.WriteHeader(http.StatusNotImplemented)
}
...
// RedirectToURL operation middleware
func (siw *ServerInterfaceWrapper) RedirectToURL(w http.ResponseWriter, r *http.Request) {
	ctx := r.Context()
	...
	err = runtime.BindStyledParameterWithOptions("simple", "shortURL", chi.URLParam(r, "shortURL"), &shortURL, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true})
	if err != nil {
	...
	handler := http.Handler(http.HandlerFunc(func(w http.ResponseWriter, r *http.Request) {
		siw.Handler.RedirectToURL(w, r, shortURL)
	}))
